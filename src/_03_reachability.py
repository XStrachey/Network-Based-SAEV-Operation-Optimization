# _03_reachability.py  (base_i2k 版)
...
from energy_utils import get_energy_rate, compute_energy_consumption, compute_multi_timestep_energy_consumption
from grid_utils import GridIndexers, load_indexer, ensure_dir, first_present
from data_loader import load_base_i2k
